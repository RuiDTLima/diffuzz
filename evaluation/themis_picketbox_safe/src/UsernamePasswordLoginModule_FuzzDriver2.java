...
public class UsernamePasswordLoginModule_FuzzDriver2 {
    public static void main(String[] args) {
       ...
       // Read all inputs.
        ...
        Mem.clear();
       boolean result1 = UsernamePasswordLoginModule.slowEquals(secret1_expected, public_actual);
        System.out.println("Answer1: " + result1);
        long cost1 = Mem.instrCost;
        System.out.println("cost1=" + cost1);
        Mem.clear();

       boolean result2 = UsernamePasswordLoginModule.slowEquals(secret2_expected, public_actual);
