...
public class Driver_MD5_2 {
    ...
    public static void main(String[] args) {
        ...
        String firstEncryption = pe.encrypt(validPassword_public);  // Added
        Mem.clear();
        //boolean valid1 = pe.matches(validPassword_public, storedPassword_valid_secret1);
        boolean valid1 = pe.regionMatches(firstEncryption, true, 0, storedPassword_valid_secret1, 0, firstEncryption.length()); // Added
        long cost1 = Mem.instrCost;
        System.out.println("valid1=" + valid1);
        System.out.println("cost1=" + cost1);

        String secondEncryption = pe.encrypt(validPassword_public); // Added
        Mem.clear();
        //boolean valid2 = pe.matches(validPassword_public, storedPassword_invalid_secret2);
        boolean valid2 = pe.regionMatches(firstEncryption, true, 0, storedPassword_invalid_secret2, 0, firstEncryption.length());   // Added
