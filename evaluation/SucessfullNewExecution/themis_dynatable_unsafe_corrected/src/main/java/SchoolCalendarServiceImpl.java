 ...
 */
public class SchoolCalendarServiceImpl extends HybridServiceServlet implements SchoolCalendarService {

    private static final String[] FIRST_NAMES = new String[] { "Inman", "Sally", "Omar", "Teddy", "Jimmy", "Cathy",
            "Barney", "Fred", "Eddie", "Carlos" };

    private static final String[] LAST_NAMES = new String[] { "Smith", "Jones", "Epps", "Gibbs", "Webber", "Blum",
            "Mendez", "Crutcher", "Needler", "Wilson", "Chase", "Edelstein" };

    private static final String[] SUBJECTS = new String[] { "Chemistry", "Phrenology", "Geometry",
            "Underwater Basket Weaving", "Basketball", "Computer Science", "Statistics", "Materials Engineering",
    ...
    /*
     * YN: actually this is a fixed value, but just because it is a sample implementation and uses no database,
     * otherwise this would be of course a variable. Therefore, we changed this to a variable that can be fuzzed.
     */
    ...
    /* YN: added constructor to dictate number of people in storage. */
    public SchoolCalendarServiceImpl(int numberOfPeople) {
    ...
    /**
     * Write the serialized response out to stdout. This is a very unusual thing to do, but it allows us to create a
     * static file version of the response without deploying a servlet.
     */
    @Override
