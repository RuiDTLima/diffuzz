...
public class Timing_FuzzDriver {
    ...
    public static void main(String[] args) {
        ...
        boolean answer1 = Timing.login_unsafe(username_secret1, password_secret1);  // MODIFIED
        long cost1 = Mem.instrCost;
        System.out.println("Answer1: " + answer1);
        System.out.println("cost1=" + cost1);

        //Timing.resetMap(username_secret2, password_secret2);
        Timing.resetMap(username, password);
        Mem.clear();
        //boolean answer2 = Timing.login_unsafe(username, password);
        boolean answer2 = Timing.login_unsafe(username_secret2, password_secret2);
