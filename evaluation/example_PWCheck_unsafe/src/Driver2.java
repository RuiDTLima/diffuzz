...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        if (SAFE_MODE) {
            ...
            Mem.clear();
            answer1 = PWCheck$Modification.pwcheck1_unsafe$Modification(public_guess, secret1_pw);
            cost1 = Mem.instrCost;
        }
        ...
        if (SAFE_MODE) {
            ...
            Mem.clear();
            answer2 = PWCheck$Modification.pwcheck1_unsafe$Modification(public_guess, secret2_pw);
            cost2 = Mem.instrCost;
        }
