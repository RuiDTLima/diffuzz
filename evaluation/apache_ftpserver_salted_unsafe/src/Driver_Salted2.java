...
public class Driver_Salted" {
    ...
    public static void main(String[] args) {
        ...
        int divider1 = storedPassword_secret1.indexOf(':');
        String storedSalt1 = storedPassword_secret1.substring(0, divider1);
        String thisString1 = pe.encrypt(passwordToCheck, storedSalt);
        Mem.clear();
        boolean valid1 = pe.regionMatches(thisString1, true, 0, password_public, 0, thisString1.length());
        long cost1 = Mem.instrCost;
        System.out.println("valid1=" + valid1);
        System.out.println("cost1=" + cost1);

        int divider2 = storedPassword_secret2.indexOf(':');
        String storedSalt2 = storedPassword_secret2.substring(0, divider2);
        String thisString2 = pe.encrypt(passwordToCheck, storedSalt);
        Mem.clear();
        boolean valid2 = pe.regionMatches(thisString2, true, 0, password_public, 0, thisString2.length());
