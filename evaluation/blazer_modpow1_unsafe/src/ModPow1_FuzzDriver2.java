...
public class ModPow1_FuzzDriver2 {
    ...
    public static void main(String[] args) {
        ...
        Mem.clear();
        BigInteger result1 = ModPow1$Modification.modPow1_unsafe$Modification(public_base, secret1_exponent, public_modulus, bitLength1);
        long cost1 = Mem.instrCost;
        System.out.println("result1=" + result1);
        System.out.println("cost1=" + cost1);

        Mem.clear();
        BigInteger result2 = ModPow1$Modification.modPow1_unsafe$Modification(public_base, secret2_exponent, public_modulus, bitLength2);
