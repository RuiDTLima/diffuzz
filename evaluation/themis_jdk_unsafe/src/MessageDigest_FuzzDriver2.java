...
public class MessageDigest_FuzzDriver {
    ...
    public static void main(String[] args) {
        ...
        Mem.clear();
        boolean answer1 = MessageDigest$Modification.isEqual_unsafe$Modification(secret1_digesta, public_digestb);
        ...
        boolean answer2 = MessageDigest$Modification.isEqual_unsafe$Modification(secret2_digesta, public_digestb);
