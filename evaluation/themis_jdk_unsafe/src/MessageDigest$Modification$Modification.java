...
public abstract class MessageDigest$Modification$Modification extends MessageDigestSpi {
    ...
    public static boolean isEqual_unsafe$Modification$Modification(byte[] digesta, byte[] digestb) {
        boolean $1 = true;
        boolean $1 = true;
        if (digesta.length != digestb.length) {
            $1 = false;
