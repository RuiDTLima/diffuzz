...
public class Driver2 {
    ...
    public static void main(String[] args) {
        ...
        boolean equal1 = TokenHandler$Modification.unsafe_isEqual$Modification(userBytes1, hash1);
        ...
        boolean equal2 = TokenHandler$Modification.unsafe_isEqual$Modification(userBytes2, hash2);
