...
public final class TokenHandler$Modification$Modification {
    ...
    public TokenHandler$Modification$Modification(byte[] secretKey, boolean safeMode) {
        try {
    ...
    public static boolean unsafe_isEqual$Modification$Modification(byte[] a, byte[] a2) {
        boolean $1 = true;
        int $2 = 0;
        boolean $1 = true;
        if (a == a2) {
