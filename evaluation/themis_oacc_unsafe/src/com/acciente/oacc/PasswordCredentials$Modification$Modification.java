...
public abstract class PasswordCredentials$Modification$Modification implements Credentials {
    ...
    private static class Impl extends PasswordCredentials {
        ...
        public static boolean ArraysIsEquals$Modification$Modification(char[] a, char[] a2) {
            boolean $1 = true;
            if (a == a2) {
                $1 = true;
            }
