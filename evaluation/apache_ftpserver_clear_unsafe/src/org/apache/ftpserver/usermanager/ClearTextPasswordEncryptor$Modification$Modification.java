...
public class ClearTextPasswordEncryptor$Modification$Modification implements PasswordEncryptor {
    private boolean safeMode;

    public ClearTextPasswordEncryptor$Modification$Modification() {
        this.safeMode = false;
    }

    public ClearTextPasswordEncryptor$Modification$Modification(boolean safeMode) {
    ...
    public boolean isEqual_unsafe$Modification$Modification(String thisObject, Object otherObject) {
        boolean $1 = false;
        boolean $1 = false;
        if (thisObject == otherObject) {
            $1 = true;
