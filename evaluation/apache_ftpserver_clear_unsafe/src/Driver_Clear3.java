...
import org.apache.ftpserver.usermanager.ClearTextPasswordEncryptor$Modification;
import org.apache.ftpserver.usermanager.PasswordEncryptor;

import edu.cmu.sv.kelinci.Kelinci;
import edu.cmu.sv.kelinci.Mem;

public class Driver_Clear2 {
    ...
    public static void main(String[] args) {
        ...
        PasswordEncryptor pe = new ClearTextPasswordEncryptor$Modification(SAFE_MODE);
        ...
        Mem.clear();
        boolean valid1 = pe.isEqual_unsafe$Modification(validPassword_public, storedPassword_valid_secret1);
        long cost1 = Mem.instrCost;
        System.out.println("valid1=" + valid1);
        System.out.println("cost1=" + cost1);

        Mem.clear();
        boolean valid2 = pe.isEqual_unsafe$Modification(validPassword_public, storedPassword_invalid_secret2);
